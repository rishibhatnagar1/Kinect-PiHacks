...
void setup() {
  ...
  myClientrx = new Client (this,"127.0.0.1",5200);
  myClientry = new Client (this,"127.0.0.1",5201);
  
  myClientlx = new Client (this,"127.0.0.1",5202);
  myCliently = new Client (this,"127.0.0.1",5203);
  myClientcx = new Client (this,"127.0.0.1",5204);
  myClientcy = new Client (this,"127.0.0.1",5205);
  //myClient.write("Sending shit bro. Be ready!");


myClientrx.write("100");
myClientry.write("110");
myClientlx.write("100");
myCliently.write("110");
myClientcx.write("100");
myClientcy.write("110");
...
void oscEvent(OscMessage theOscMessage) {
  ...
  if (v.equals("/righthand_pos_screen")) {
    ...
    rhx=x;
    rhy=y;
    myClientrx.write(str(rhx));
    myClientry.write(str(rhy));
  ...
  if (v.equals("/lefthand_pos_screen")) {
    ...
    lhx=x;
    lhy=y;
    myClientlx.write(str(lhx));
    myCliently.write(str(lhy));
  ...
  if (v.equals("/torso_pos_screen")) {
    ...
    tx=x;
    ty=y;
    myClientcx.write(str(tx));
    myClientcy.write(str(ty));
  }
}
